...
import { userCreate } from '@/actions/auth/userAuth';
...
export default async function UserCreate() {
    ...
    return (
        <div className="user-list p-4">
            <h1 className="text-2xl font-bold mb-4">User Create</h1>
            <form action={userCreate} className="w-full  mt-3 p-6 bg-white shadow-md rounded-md">
                <div className="mb-4">
